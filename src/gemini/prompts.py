...
- **Обязательно предложи напитки**, если они есть в меню.
- **Расчет**: Предлагай примерно 500-1000 мл безалкогольных напитков (морсы, соки, вода) на человека, исходя из бюджета и типа мероприятия.
